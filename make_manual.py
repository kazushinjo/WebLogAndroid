...
add_para('バージョン 1.08（2026-05-13 更新）　対応機種: Android 8.0 (API 26) 以上')
doc.add_paragraph()
...
add_para('・列: 日付 / 時刻 / コールサイン / バンド / 周波数 / モード / RST送 / RST受 / 名前 / QTH / JCC / QSL / 備考 / 編集 / 削除', indent=True)
...
add_table(
    ['日付', '更新内容'],
    [
        ('2026-05-13 初版', '初版リリース（Android版 v1.08）'),
        ('2026-05-13 改訂',
         '・ボタンのコントラスト改善（白文字に修正）\n'
